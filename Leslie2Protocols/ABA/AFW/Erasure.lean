...
noncomputable def protocol₀ (P : Params) :
    System (Net.FlatState P (Msg P.n) (StageRec P.n) Unit) (Lab P.n) :=
  Net.flat₀ P (Msg P.n) (StageRec P.n) (StageStep P) (gCallPayload P)
...
theorem protocol_erasure (P : Params) :
  ...
  Net.flat_erasure P (Msg P.n) (StageRec P.n) (Ghost P.n) (StageStep P)
