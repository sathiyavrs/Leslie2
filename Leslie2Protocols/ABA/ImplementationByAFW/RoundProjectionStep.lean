...
`AFW.toRound` (`ABA/ImplementationByAFW/RoundProjection.lean`) computes the round-`r` state of the
...
applied, written through the updaters `GBCA.ByAFW.setProcs`, `GBCA.ByAFW.setBound`,
`GBCA.ByAFW.setGa1`, `GBCA.ByAFW.setGa2`, `Gather.setGa`, `Gather.setBrbIn`,
...
instances. -/
theorem roundStateAt_ext {n : ℕ} {G₁ G₂ : Type} {a b : GBCA.ByAFW.RoundStateAt n G₁ G₂}
    (h1 : GBCA.ByAFW.procs a = GBCA.ByAFW.procs b) (h2 : GBCA.ByAFW.bound a = GBCA.ByAFW.bound b)
    (h3 : GBCA.ByAFW.ga1 a = GBCA.ByAFW.ga1 b)
    (h4 : GBCA.ByAFW.ga2 a = GBCA.ByAFW.ga2 b) : a = b := by
...
theorem toRound_write (u : ∀ _ : Fin P.n, AFW.ProcRec P.n) (w : NetState P.n)
  ...
  · simp only [GBCA.ByAFW.procs, toRound, toRoundUpd, stage_update_self rfl, locals_toProc_if]
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, GBCA.ByAFW.ga1, toRound, toRoundUpd, toGa1, stage_update_self rfl,
      locals_view1_if]
    · simp only [Gather.ga, GBCA.ByAFW.ga1, toRound, toRoundUpd, toGa1, gsent_sent_self]
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbIn, GBCA.ByAFW.ga1, toRound, toRoundUpd, toGa1, stage_update_self rfl,
      locals_in1_if]
    · simp only [Gather.brbIn, GBCA.ByAFW.ga1, toRound, toRoundUpd, toGa1, gsent_sent_self]
  · funext q
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbBind, GBCA.ByAFW.ga1, toRound, toRoundUpd, toGa1,
      stage_update_self rfl, locals_bind1_if]
    · simp only [Gather.brbBind, GBCA.ByAFW.ga1, toRound, toRoundUpd, toGa1, gsent_sent_self]
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, GBCA.ByAFW.ga2, toRound, toRoundUpd, toGa2, stage_update_self rfl,
      locals_view2_if]
    · simp only [Gather.ga, GBCA.ByAFW.ga2, toRound, toRoundUpd, toGa2, gsent_sent_self]
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbIn, GBCA.ByAFW.ga2, toRound, toRoundUpd, toGa2, stage_update_self rfl,
      locals_in2_if]
    · simp only [Gather.brbIn, GBCA.ByAFW.ga2, toRound, toRoundUpd, toGa2, gsent_sent_self]
  · funext q
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbBind, GBCA.ByAFW.ga2, toRound, toRoundUpd, toGa2,
      stage_update_self rfl, locals_bind2_if]
    · simp only [Gather.brbBind, GBCA.ByAFW.ga2, toRound, toRoundUpd, toGa2, gsent_sent_self]
...
theorem toRound_writeNoSent (u : ∀ _ : Fin P.n, AFW.ProcRec P.n) (w : NetState P.n)
  ...
  · funext q
    refine Prod.ext ?_ (networkState_ext rfl rfl)
    simp only [Gather.brbBind, GBCA.ByAFW.ga1, toRound, toRoundUpd, toGa1, stage_update_self rfl,
      locals_bind1_if]
  · refine Prod.ext ?_ (networkState_ext rfl rfl)
    simp only [Gather.ga, GBCA.ByAFW.ga2, toRound, toRoundUpd, toGa2, stage_update_self rfl,
      locals_view2_if]
  ...
  · funext q
    refine Prod.ext ?_ (networkState_ext rfl rfl)
    simp only [Gather.brbBind, GBCA.ByAFW.ga2, toRound, toRoundUpd, toGa2, stage_update_self rfl,
      locals_bind2_if]
...
@[simp] theorem procs_mk {G₁ G₂ : Type} (a : ∀ _ : Fin P.n, GBCA.ByAFW.ProcRec P.n)
    (bnd : Option Bool) (x : G₁) (y : G₂) :
    GBCA.ByAFW.procs (((a, bnd), (x, y)) : GBCA.ByAFW.RoundStateAt P.n G₁ G₂) = a := rfl

@[simp] theorem bound_mk {G₁ G₂ : Type} (a : ∀ _ : Fin P.n, GBCA.ByAFW.ProcRec P.n)
    (bnd : Option Bool) (x : G₁) (y : G₂) :
    GBCA.ByAFW.bound (((a, bnd), (x, y)) : GBCA.ByAFW.RoundStateAt P.n G₁ G₂) = bnd := rfl

@[simp] theorem ga1_mk {G₁ G₂ : Type} (a : ∀ _ : Fin P.n, GBCA.ByAFW.ProcRec P.n)
    (bnd : Option Bool) (x : G₁) (y : G₂) :
    GBCA.ByAFW.ga1 (((a, bnd), (x, y)) : GBCA.ByAFW.RoundStateAt P.n G₁ G₂) = x := rfl

@[simp] theorem ga2_mk {G₁ G₂ : Type} (a : ∀ _ : Fin P.n, GBCA.ByAFW.ProcRec P.n)
    (bnd : Option Bool) (x : G₁) (y : G₂) :
    GBCA.ByAFW.ga2 (((a, bnd), (x, y)) : GBCA.ByAFW.RoundStateAt P.n G₁ G₂) = y := rfl
...
@[simp] theorem procs_toRound_eq :
    GBCA.ByAFW.procs (toRound P v w r) = fun i => toProc ((v i).2.stage r) := rfl

@[simp] theorem procs_toRoundUpd :
    GBCA.ByAFW.procs (toRoundUpd P v w r j sr sent)
      = Function.update (fun i => toProc ((v i).2.stage r)) j (toProc sr) := rfl

@[simp] theorem bound_toRoundUpd :
    GBCA.ByAFW.bound (toRoundUpd P v w r j sr sent) = (w.ghostRec r).2.2 := rfl

@[simp] theorem core_ga1_toRoundUpd :
    Gather.core (GBCA.ByAFW.ga1 (toRoundUpd P v w r j sr sent)) = (w.ghostRec r).1 := rfl

@[simp] theorem core_ga2_toRoundUpd :
    Gather.core (GBCA.ByAFW.ga2 (toRoundUpd P v w r j sr sent)) = (w.ghostRec r).2.1 := rfl

@[simp] theorem ga_ga1_toRoundUpd :
    Gather.ga (GBCA.ByAFW.ga1 (toRoundUpd P v w r j sr sent))
...
@[simp] theorem ga_ga2_toRoundUpd :
    Gather.ga (GBCA.ByAFW.ga2 (toRoundUpd P v w r j sr sent))
...
@[simp] theorem brbIn_ga1_toRoundUpd (k : Fin P.n) :
    Gather.brbIn (GBCA.ByAFW.ga1 (toRoundUpd P v w r j sr sent)) k
...
@[simp] theorem brbBind_ga1_toRoundUpd (q : Fin P.n) :
    Gather.brbBind (GBCA.ByAFW.ga1 (toRoundUpd P v w r j sr sent)) q
...
@[simp] theorem brbIn_ga2_toRoundUpd (k : Fin P.n) :
    Gather.brbIn (GBCA.ByAFW.ga2 (toRoundUpd P v w r j sr sent)) k
...
@[simp] theorem brbBind_ga2_toRoundUpd (q : Fin P.n) :
    Gather.brbBind (GBCA.ByAFW.ga2 (toRoundUpd P v w r j sr sent)) q
...
theorem toRound_ga1Send (hu : (u j).2 = p) (r : ℕ) (pr : Gather.PRec P.n Bool)
  ...
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, Gather.setGa, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound, toRoundUpd,
      toGa1, gaProcView, SubState.mcast, SubState.setProc, LocalState.setP]
    · simp only [Gather.ga, Gather.setGa, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound, toRoundUpd,
      toGa1, SubState.mcast, NetworkState.post]
      exact slice_post_some unGa1 unGa1_inj (w.sent r) j (.ga1 m) m rfl
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbIn, Gather.setGa, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
        toRoundUpd, toGa1]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbIn, Gather.setGa, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
        toRoundUpd, toGa1]
  ...
  · funext q
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbBind, Gather.setGa, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
      toRoundUpd, toGa1]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbBind, Gather.setGa, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
      toRoundUpd, toGa1]
  ...
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa1, toRound, toRoundUpd, toGa2]
      exact Function.update_eq_self _ _
    · simp only [Gather.ga, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa1, toRound, toRoundUpd, toGa2]
      exact slice_post_none unGa2 unGa2_inj (w.sent r) j (.ga1 m) rfl
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbIn, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa1, toRound, toRoundUpd, toGa2]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbIn, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa1, toRound, toRoundUpd, toGa2]
      exact slice_post_none (unIn2 k) (unIn2_inj k) (w.sent r) j (.ga1 m) rfl
  · funext q
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbBind, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa1, toRound, toRoundUpd, toGa2]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbBind, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa1, toRound, toRoundUpd, toGa2]
...
theorem toRound_ga2Send (hu : (u j).2 = p) (r : ℕ) (pr : Gather.PRec P.n (Option Bool))
  ...
  · simp only [GBCA.ByAFW.procs, GBCA.ByAFW.setGa2, toRound, toRoundUpd, toProc, LocalState.setP,
    ...
    exact Function.update_eq_self _ _
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa1]
      exact Function.update_eq_self _ _
    · simp only [Gather.ga, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa1]
      exact slice_post_none unGa1 unGa1_inj (w.sent r) j (.ga2 m) rfl
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbIn, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa1]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbIn, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa1]
      exact slice_post_none (unIn1 k) (unIn1_inj k) (w.sent r) j (.ga2 m) rfl
  · funext q
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbBind, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa1]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbBind, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa1]
      exact slice_post_none (unBind1 q) (unBind1_inj q) (w.sent r) j (.ga2 m) rfl
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, Gather.setGa, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound, toRoundUpd,
      toGa2, gaProcView, SubState.mcast, SubState.setProc, LocalState.setP]
    · simp only [Gather.ga, Gather.setGa, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound, toRoundUpd,
      toGa2, SubState.mcast, NetworkState.post]
      exact slice_post_some unGa2 unGa2_inj (w.sent r) j (.ga2 m) m rfl
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbIn, Gather.setGa, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
        toRoundUpd, toGa2]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbIn, Gather.setGa, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
        toRoundUpd, toGa2]
  ...
  · funext q
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbBind, Gather.setGa, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
      toRoundUpd, toGa2]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbBind, Gather.setGa, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
      toRoundUpd, toGa2]
...
theorem toRound_in1Send (hu : (u j).2 = p) (r : ℕ) (i : Fin P.n)
  ...
  rw [← hu, toRound_write]
  refine roundStateAt_ext ?_ rfl (subStateAt_ext ?_ ?_ ?_ rfl) (subStateAt_ext ?_ ?_ ?_ rfl)
  · simp only [GBCA.ByAFW.procs, GBCA.ByAFW.setGa1, toRound, toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, Gather.setBrbIn, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
  ...
  · funext k
    ...
    · subst hk
      ...
      · simp only [Gather.brbIn, Gather.setBrbIn, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
  ...
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbBind, Gather.setBrbIn, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
      toRoundUpd, toGa1]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbBind, Gather.setBrbIn, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
      toRoundUpd, toGa1]
...
theorem toRound_bind1Send (hu : (u j).2 = p) (r : ℕ) (i : Fin P.n)
  ...
  · simp only [GBCA.ByAFW.procs, GBCA.ByAFW.setGa1, toRound, toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, Gather.setBrbBind, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
      toRoundUpd, toGa1, gaProcView, storeIn_update_setP]
      exact Function.update_eq_self _ _
    · simp only [Gather.ga, Gather.setBrbBind, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
      toRoundUpd, toGa1]
  ...
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbIn, Gather.setBrbBind, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
      toRoundUpd, toGa1]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbIn, Gather.setBrbBind, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
      toRoundUpd, toGa1]
  ...
  · funext k
    ...
    · subst hk
      refine Prod.ext ?_ (networkState_ext ?_ ?_)
      · simp only [Gather.brbBind, Gather.setBrbBind, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
        toRoundUpd, toGa1, Function.update_self, SubState.mcast, SubState.setProc, brbLocal,
        LocalState.setP, storeIn_mk_eq]
      · simp only [Gather.brbBind, Gather.setBrbBind, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1, toRound,
        toRoundUpd, toGa1, Function.update_self, SubState.mcast, NetworkState.post]
...
theorem toRound_in2Send (hu : (u j).2 = p) (r : ℕ) (i : Fin P.n)
  ...
  rw [← hu, toRound_write]
  refine roundStateAt_ext ?_ rfl (subStateAt_ext ?_ ?_ ?_ rfl) (subStateAt_ext ?_ ?_ ?_ rfl)
  · simp only [GBCA.ByAFW.procs, GBCA.ByAFW.setGa2, toRound, toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa1]
      exact Function.update_eq_self _ _
  ...
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, Gather.setBrbIn, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
  ...
  · funext k
    ...
    · subst hk
      refine Prod.ext ?_ (networkState_ext ?_ ?_)
      · simp only [Gather.brbIn, Gather.setBrbIn, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
  ...
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbBind, Gather.setBrbIn, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
      toRoundUpd, toGa2]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbBind, Gather.setBrbIn, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
      toRoundUpd, toGa2]
...
theorem toRound_bind2Send (hu : (u j).2 = p) (r : ℕ) (i : Fin P.n)
  ...
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, Gather.setBrbBind, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
      toRoundUpd, toGa2, gaProcView, storeIn_update_setP]
      exact Function.update_eq_self _ _
    · simp only [Gather.ga, Gather.setBrbBind, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
      toRoundUpd, toGa2]
  ...
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbIn, Gather.setBrbBind, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
      toRoundUpd, toGa2]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbIn, Gather.setBrbBind, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
      toRoundUpd, toGa2]
  ...
  · funext k
    ...
    · subst hk
      refine Prod.ext ?_ (networkState_ext ?_ ?_)
      · simp only [Gather.brbBind, Gather.setBrbBind, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
        toRoundUpd, toGa2, Function.update_self, SubState.mcast, SubState.setProc, brbLocal,
        LocalState.setP, storeIn_mk_eq]
      · simp only [Gather.brbBind, Gather.setBrbBind, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2, toRound,
        toRoundUpd, toGa2, Function.update_self, SubState.mcast, NetworkState.post]
...
theorem toRound_ga1Bind (hu : (u j).2 = p) (r : ℕ) (U : Gather.APSet P.n Bool) :
  ...
  · simp only [GBCA.ByAFW.procs, GBCA.ByAFW.setGa1, toRound, toRoundUpd, toProc, LocalState.setP]
    exact Function.update_eq_self _ _
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1,
      toRound, toRoundUpd, toGa1, gaProcView, storeIn_update_setP]
  ...
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbIn, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1,
      toRound, toRoundUpd, toGa1]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbIn, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga1, GBCA.ByAFW.setGa1,
      toRound, toRoundUpd, toGa1]
  ...
  · funext k
    ...
    · subst hk
      refine Prod.ext ?_ (networkState_ext ?_ ?_)
      · simp only [Gather.brbBind, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga1,
        GBCA.ByAFW.setGa1, toRound, toRoundUpd, toGa1, Function.update_self, SubState.mcast,
          SubState.setProc,
    ...
    · refine Prod.ext ?_ (networkState_ext ?_ ?_)
      · simp only [Gather.brbBind, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga1,
        GBCA.ByAFW.setGa1, toRound, toRoundUpd, toGa1, Function.update_of_ne hk]
        exact Function.update_eq_self _ _
      · simp only [Gather.brbBind, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga1,
        GBCA.ByAFW.setGa1, toRound, toRoundUpd, toGa1, Function.update_of_ne hk]
...
theorem toRound_ga2Bind (hu : (u j).2 = p) (r : ℕ) (U : Gather.APSet P.n (Option Bool)) :
  ...
  · refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.ga, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2,
      toRound, toRoundUpd, toGa2, gaProcView, storeIn_update_setP]
      simp only [SubState.setProc, SubState.proc, LocalState.setP]
    · simp only [Gather.ga, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2,
  ...
  · funext k
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
    · simp only [Gather.brbIn, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2,
      toRound, toRoundUpd, toGa2]
      exact Function.update_eq_self _ _
    · simp only [Gather.brbIn, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga2, GBCA.ByAFW.setGa2,
      toRound, toRoundUpd, toGa2]
  ...
  · funext k
    ...
    · subst hk
      refine Prod.ext ?_ (networkState_ext ?_ ?_)
      · simp only [Gather.brbBind, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga2,
        GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa2, Function.update_self, SubState.mcast,
          SubState.setProc,
        SubState.proc, brbLocal, LocalState.setP, storeIn_mk_eq]
      · simp only [Gather.brbBind, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga2,
        GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa2, Function.update_self, SubState.mcast,
    ...
    · refine Prod.ext ?_ (networkState_ext ?_ ?_)
      · simp only [Gather.brbBind, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga2,
        GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa2, Function.update_of_ne hk]
        exact Function.update_eq_self _ _
      · simp only [Gather.brbBind, Gather.setBrbBind, Gather.setGa, GBCA.ByAFW.ga2,
        GBCA.ByAFW.setGa2, toRound, toRoundUpd, toGa2, Function.update_of_ne hk]
...
theorem toRound_callG (hu : (u j).2 = p) (r : ℕ) (b : Bool) :
    toRound P (Function.update u j (c, p.setStage r
      ...
      = GBCA.ByAFW.setGa1 (GBCA.ByAFW.setProcs (toRound P u w r)
            (Function.update (GBCA.ByAFW.procs (toRound P u w r)) j
              { GBCA.ByAFW.procs (toRound P u w r) j with input := some b }))
  ...
  · simp only [procs_toRoundUpd, GBCA.ByAFW.procs_setGa1, GBCA.ByAFW.procs_setProcs,
      procs_toRound_eq]
    refine congrArg (Function.update (fun i => toProc ((u i).2.stage r)) j) ?_
    simp only [toProc, LocalState.setP]
  · simp
  · simp only [ga_ga1_toRoundUpd, GBCA.ByAFW.ga1_setGa1, Gather.ga_setBrbIn, Gather.ga_setGa]
    refine Prod.ext ?_ (networkState_ext ?_ rfl)
  ...
  · funext k
    simp only [brbIn_ga1_toRoundUpd, GBCA.ByAFW.ga1_setGa1, Gather.brbIn_setBrbIn, brbIn_toGa1]
    by_cases hk : k = j
    · subst hk
    ...
    · rw [Function.update_of_ne hk, Function.update_of_ne hk]
      ...
      exact slice_post_none (unIn1 k) (unIn1_inj k) (w.sent r) j (.brbIn1 j (.init b))
        (by simp [unIn1, Ne.symm hk])
  · funext q
    simp only [brbBind_ga1_toRoundUpd, GBCA.ByAFW.ga1_setGa1, Gather.brbBind_setBrbIn,
      Gather.brbBind_setGa, brbBind_toGa1]
    refine Prod.ext (Function.update_eq_self _ _) (networkState_ext ?_ rfl)
    exact slice_post_none (unBind1 q) (unBind1_inj q) (w.sent r) j (.brbIn1 j (.init b)) rfl
  · simp
  · simp only [ga_ga2_toRoundUpd, GBCA.ByAFW.ga2_setGa1, GBCA.ByAFW.ga2_setProcs, ga2_toRound]
    refine Prod.ext (Function.update_eq_self _ _) (networkState_ext ?_ rfl)
    exact slice_post_none unGa2 unGa2_inj (w.sent r) j (.brbIn1 j (.init b)) rfl
  · funext k
    simp only [brbIn_ga2_toRoundUpd, GBCA.ByAFW.ga2_setGa1, GBCA.ByAFW.ga2_setProcs, ga2_toRound,
      brbIn_toGa2]
    refine Prod.ext (Function.update_eq_self _ _) (networkState_ext ?_ rfl)
    exact slice_post_none (unIn2 k) (unIn2_inj k) (w.sent r) j (.brbIn1 j (.init b)) rfl
  · funext q
    simp only [brbBind_ga2_toRoundUpd, GBCA.ByAFW.ga2_setGa1, GBCA.ByAFW.ga2_setProcs, ga2_toRound,
      brbBind_toGa2]
    refine Prod.ext (Function.update_eq_self _ _) (networkState_ext ?_ rfl)
...
theorem toGa1_write (u : ∀ _ : Fin P.n, AFW.ProcRec P.n) (w : NetState P.n)
    ...
    toGa1 P (Function.update u j (c, (u j).2.setStage r sr)) (w.gsent r j m) r
      = GBCA.ByAFW.ga1 (toRoundUpd P u w r j sr
          (Function.update (w.sent r) j (insert m (w.sent r j)))) :=
  congrArg GBCA.ByAFW.ga1 (toRound_write u w j c r sr m)
...
theorem toGa2_write (u : ∀ _ : Fin P.n, AFW.ProcRec P.n) (w : NetState P.n)
    ...
    toGa2 P (Function.update u j (c, (u j).2.setStage r sr)) (w.gsent r j m) r
      = GBCA.ByAFW.ga2 (toRoundUpd P u w r j sr
          (Function.update (w.sent r) j (insert m (w.sent r j)))) :=
  congrArg GBCA.ByAFW.ga2 (toRound_write u w j c r sr m)
  ...
  GBCA.ByAFW.setGa1
    (GBCA.ByAFW.setBound
      (GBCA.ByAFW.setProcs s (Function.update (GBCA.ByAFW.procs s) j
        { GBCA.ByAFW.procs s j with cand := some (GBCA.cand P g) }))
      (some ((GBCA.ByAFW.bound s).getD (GBCA.boundOfCore P (ret1Core P s)))))
    (Gather.setCore
      (Gather.setGa (GBCA.ByAFW.ga1 s)
        ((Gather.ga (GBCA.ByAFW.ga1 s)).setProc j
          { (Gather.ga (GBCA.ByAFW.ga1 s)).proc j with returned := true }))
      (some (ret1Core P s)))
  ...
  GBCA.ByAFW.setGa2
    ...
    (Gather.setBrbIn
      (Gather.setGa (GBCA.ByAFW.ga2 s)
        ((Gather.ga (GBCA.ByAFW.ga2 s)).setProc j
          { (Gather.ga (GBCA.ByAFW.ga2 s)).proc j with input := some x }))
      (Function.update (Gather.brbIn (GBCA.ByAFW.ga2 s)) j
        (((Gather.brbIn (GBCA.ByAFW.ga2 s) j).setProc j
            { (Gather.brbIn (GBCA.ByAFW.ga2 s) j).proc j with input := some x }).mcast
          j (.init x))))
...
noncomputable def afterRet2 (P : Params) (s : GBCA.ByAFW.LowPairState P.n) (j : Fin P.n)
  ...
  GBCA.ByAFW.setGa2
    ...
    (Gather.setCore
      (Gather.setGa (GBCA.ByAFW.ga2 s)
        ((Gather.ga (GBCA.ByAFW.ga2 s)).setProc j
          { (Gather.ga (GBCA.ByAFW.ga2 s)).proc j with returned := true }))
      (some (ret2Core P s)))
...
theorem toRound_ret1_call2 (hu : (u j).2 = p) (r : ℕ) (g : Fin P.n → Option Bool) :
  ...
  · simp only [afterCall2, afterRet1, GBCA.ByAFW.procs_setGa2, GBCA.ByAFW.procs_setProcs,
    GBCA.ByAFW.procs_setGa1, GBCA.ByAFW.procs_setBound, procs_toRound_eq, Function.update_idem,
    stage_update_self rfl, locals_toProc_if, Function.update_self]
    simp only [procs_mk, toProc, LocalState.setP, Option.isSome_some]
  · simp only [afterCall2, afterRet1, GBCA.ByAFW.bound_setGa2, GBCA.ByAFW.bound_setProcs,
    GBCA.ByAFW.bound_setGa1, GBCA.ByAFW.bound_setBound, bound_toRound, ret1Core, ga1_toRound,
      core_toGa1]
    simp only [bound_mk, ghostStep, hcore]
  · simp only [afterCall2, afterRet1, GBCA.ByAFW.ga1_setGa2, GBCA.ByAFW.ga1_setProcs,
    GBCA.ByAFW.ga1_setGa1, ga1_toRound]
    simp only [ga1_mk]
  ...
  · simp only [afterCall2, afterRet1, GBCA.ByAFW.ga2_setGa2, GBCA.ByAFW.ga2_setProcs,
    GBCA.ByAFW.ga2_setBound, GBCA.ByAFW.ga2_setGa1, ga2_toRound]
    simp only [ga2_mk]
    refine subStateAt_ext ?_ ?_ ?_ ?_
...
theorem toGa1_writeNoSent (u : ∀ _ : Fin P.n, AFW.ProcRec P.n) (w : NetState P.n)
    ...
    toGa1 P (Function.update u j (c, (u j).2.setStage r sr)) w r
      = GBCA.ByAFW.ga1 (toRoundUpd P u w r j sr (w.sent r)) :=
  congrArg GBCA.ByAFW.ga1 (toRound_writeNoSent u w j c r sr)
...
theorem toGa2_writeNoSent (u : ∀ _ : Fin P.n, AFW.ProcRec P.n) (w : NetState P.n)
    ...
    toGa2 P (Function.update u j (c, (u j).2.setStage r sr)) w r
      = GBCA.ByAFW.ga2 (toRoundUpd P u w r j sr (w.sent r)) :=
  congrArg GBCA.ByAFW.ga2 (toRound_writeNoSent u w j c r sr)
...
theorem toRound_ret2_retG (hu : (u j).2 = p) (r : ℕ)
  ...
  · simp only [afterRetG, afterRet2, GBCA.ByAFW.bound_setProcs, GBCA.ByAFW.bound_setGa2,
      bound_toRound]
    simp only [bound_mk, ghostStep]
  · simp only [afterRetG, afterRet2, GBCA.ByAFW.ga1_setProcs, GBCA.ByAFW.ga1_setGa2, ga1_toRound]
  ...
  · simp only [afterRetG, afterRet2, GBCA.ByAFW.ga2_setProcs, GBCA.ByAFW.ga2_setGa2, ga2_toRound]
...
theorem toRound_dlvGa1 (hu : (u j).2 = p) (r : ℕ) (k : Fin P.n)
  ...
  refine roundStateAt_ext ?_ ?_ ?_ ?_
  · simp only [GBCA.ByAFW.procs_setGa1, procs_toRound_eq, procs_toRoundUpd, toProc,
    LocalState.deliverTo]
    exact Function.update_eq_self _ _
  · simp
  · simp only [GBCA.ByAFW.ga1_setGa1]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    ...
    · funext q
      ...
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · simp
  · simp only [GBCA.ByAFW.ga2_setGa1, ga2_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
...
theorem toRound_dlvGa2 (hu : (u j).2 = p) (r : ℕ) (k : Fin P.n)
  ...
  rw [toRound_writeNoSent]
  refine roundStateAt_ext ?_ ?_ ?_ ?_
  · simp only [GBCA.ByAFW.procs_setGa2, procs_toRound_eq, procs_toRoundUpd, toProc,
    LocalState.deliverTo]
    exact Function.update_eq_self _ _
  · simp
  · simp only [GBCA.ByAFW.ga1_setGa2, ga1_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    ...
    · funext q
      ...
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · simp
  · simp only [GBCA.ByAFW.ga2_setGa2]
    refine subStateAt_ext ?_ ?_ ?_ ?_
  ...
  GBCA.ByAFW.setGa1 s
    (Gather.setBrbIn (GBCA.ByAFW.ga1 s)
      (Function.update (Gather.brbIn (GBCA.ByAFW.ga1 s)) i
        ((Gather.brbIn (GBCA.ByAFW.ga1 s) i).recvMsg j k m)))
...
noncomputable def afterInRet1 (P : Params) (s : GBCA.ByAFW.LowPairState P.n)
  ...
  GBCA.ByAFW.setGa1 s
    (Gather.setBrbIn
      (Gather.setGa (GBCA.ByAFW.ga1 s)
        ((Gather.ga (GBCA.ByAFW.ga1 s)).setProc j
          { (Gather.ga (GBCA.ByAFW.ga1 s)).proc j with
            delivIn :=
              Function.update ((Gather.ga (GBCA.ByAFW.ga1 s)).proc j).delivIn i (some v) }))
      (Function.update (Gather.brbIn (GBCA.ByAFW.ga1 s)) i
        ((Gather.brbIn (GBCA.ByAFW.ga1 s) i).setProc j
          { (Gather.brbIn (GBCA.ByAFW.ga1 s) i).proc j with returned := true })))
...
theorem toRound_dlvIn1 (hu : (u j).2 = p) (r : ℕ) (i k : Fin P.n)
  ...
  rw [toRound_writeNoSent]
  refine roundStateAt_ext ?_ ?_ ?_ ?_
  · simp only [afterDlvIn1, GBCA.ByAFW.procs_setGa1, procs_toRound_eq, procs_toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · simp [afterDlvIn1]
  · simp only [afterDlvIn1, GBCA.ByAFW.ga1_setGa1, ga1_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    ...
    · funext q
      ...
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · simp
  · simp only [afterDlvIn1, GBCA.ByAFW.ga2_setGa1, ga2_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    · simp only [ga_ga2_toRoundUpd]
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · funext k'
...
theorem toRound_dlvIn1_ret (hu : (u j).2 = p) (r : ℕ) (i k : Fin P.n)
  ...
  rw [toRound_writeNoSent]
  refine roundStateAt_ext ?_ ?_ ?_ ?_
  · simp only [afterInRet1, afterDlvIn1, GBCA.ByAFW.procs_setGa1, procs_toRound_eq,
    procs_toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · simp [afterInRet1, afterDlvIn1]
  · simp only [afterInRet1, afterDlvIn1, GBCA.ByAFW.ga1_setGa1, ga1_toRound, Gather.ga_setBrbIn,
    ...
    · funext q
      ...
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · simp
  · simp only [afterInRet1, afterDlvIn1, GBCA.ByAFW.ga2_setGa1, ga2_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    · simp only [ga_ga2_toRoundUpd]
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · funext k'
  ...
  GBCA.ByAFW.setGa1 s
    (Gather.setBrbBind (GBCA.ByAFW.ga1 s)
      (Function.update (Gather.brbBind (GBCA.ByAFW.ga1 s)) i
        ((Gather.brbBind (GBCA.ByAFW.ga1 s) i).recvMsg j k m)))
    ...
    (Gather.setBrbBind
      (Gather.setGa (GBCA.ByAFW.ga1 s)
        ((Gather.ga (GBCA.ByAFW.ga1 s)).setProc j
          { (Gather.ga (GBCA.ByAFW.ga1 s)).proc j with
            delivBind :=
              Function.update ((Gather.ga (GBCA.ByAFW.ga1 s)).proc j).delivBind i (some v) }))
      (Function.update (Gather.brbBind (GBCA.ByAFW.ga1 s)) i
        ((Gather.brbBind (GBCA.ByAFW.ga1 s) i).setProc j
          { (Gather.brbBind (GBCA.ByAFW.ga1 s) i).proc j with returned := true })))
...
theorem toRound_dlvBind1 (hu : (u j).2 = p) (r : ℕ) (i k : Fin P.n)
  ...
  rw [toRound_writeNoSent]
  refine roundStateAt_ext ?_ ?_ ?_ ?_
  · simp only [afterDlvBind1, GBCA.ByAFW.procs_setGa1, procs_toRound_eq, procs_toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · simp [afterDlvBind1]
  · simp only [afterDlvBind1, GBCA.ByAFW.ga1_setGa1, ga1_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    ...
    · funext k'
      ...
      · rw [Function.update_of_ne hk, Function.update_of_ne hk]
        exact Prod.ext (Function.update_eq_self _ _) rfl
    · simp
  · simp only [afterDlvBind1, GBCA.ByAFW.ga2_setGa1, ga2_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    · simp only [ga_ga2_toRoundUpd]
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · funext k'
...
theorem toRound_dlvBind1_ret (hu : (u j).2 = p) (r : ℕ) (i k : Fin P.n)
  ...
  rw [toRound_writeNoSent]
  refine roundStateAt_ext ?_ ?_ ?_ ?_
  · simp only [afterBindRet1, afterDlvBind1, GBCA.ByAFW.procs_setGa1, procs_toRound_eq,
    procs_toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · simp [afterBindRet1, afterDlvBind1]
  · simp only [afterBindRet1, afterDlvBind1, GBCA.ByAFW.ga1_setGa1, ga1_toRound,
    ...
    · funext k'
      ...
      · rw [Function.update_of_ne hk, Function.update_of_ne hk,
        ...
        exact Prod.ext (Function.update_eq_self _ _) rfl
    · simp
  · simp only [afterBindRet1, afterDlvBind1, GBCA.ByAFW.ga2_setGa1, ga2_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    · simp only [ga_ga2_toRoundUpd]
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · funext k'
  ...
  GBCA.ByAFW.setGa2 s
    (Gather.setBrbIn (GBCA.ByAFW.ga2 s)
      (Function.update (Gather.brbIn (GBCA.ByAFW.ga2 s)) i
        ((Gather.brbIn (GBCA.ByAFW.ga2 s) i).recvMsg j k m)))
...
noncomputable def afterInRet2 (P : Params) (s : GBCA.ByAFW.LowPairState P.n)
  ...
  GBCA.ByAFW.setGa2 s
    (Gather.setBrbIn
      (Gather.setGa (GBCA.ByAFW.ga2 s)
        ((Gather.ga (GBCA.ByAFW.ga2 s)).setProc j
          { (Gather.ga (GBCA.ByAFW.ga2 s)).proc j with
            delivIn :=
              Function.update ((Gather.ga (GBCA.ByAFW.ga2 s)).proc j).delivIn i (some v) }))
      (Function.update (Gather.brbIn (GBCA.ByAFW.ga2 s)) i
        ((Gather.brbIn (GBCA.ByAFW.ga2 s) i).setProc j
          { (Gather.brbIn (GBCA.ByAFW.ga2 s) i).proc j with returned := true })))
...
theorem toRound_dlvIn2 (hu : (u j).2 = p) (r : ℕ) (i k : Fin P.n)
  ...
  rw [toRound_writeNoSent]
  refine roundStateAt_ext ?_ ?_ ?_ ?_
  · simp only [afterDlvIn2, GBCA.ByAFW.procs_setGa2, procs_toRound_eq, procs_toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · simp [afterDlvIn2]
  · simp only [afterDlvIn2, GBCA.ByAFW.ga1_setGa2, ga1_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    · simp only [ga_ga1_toRoundUpd]
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · funext k'
    ...
    · funext q
      ...
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · simp
  · simp only [afterDlvIn2, GBCA.ByAFW.ga2_setGa2, ga2_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
...
theorem toRound_dlvIn2_ret (hu : (u j).2 = p) (r : ℕ) (i k : Fin P.n)
  ...
  rw [toRound_writeNoSent]
  refine roundStateAt_ext ?_ ?_ ?_ ?_
  · simp only [afterInRet2, afterDlvIn2, GBCA.ByAFW.procs_setGa2, procs_toRound_eq,
    procs_toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · simp [afterInRet2, afterDlvIn2]
  · simp only [afterInRet2, afterDlvIn2, GBCA.ByAFW.ga1_setGa2, ga1_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    · simp only [ga_ga1_toRoundUpd]
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · funext k'
    ...
    · funext q
      ...
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · simp
  · simp only [afterInRet2, afterDlvIn2, GBCA.ByAFW.ga2_setGa2, ga2_toRound, Gather.ga_setBrbIn,
    Gather.brbIn_setBrbIn]
    refine subStateAt_ext ?_ ?_ ?_ ?_
...
noncomputable def afterDlvBind2 (P : Params) (s : GBCA.ByAFW.LowPairState P.n)
  ...
  GBCA.ByAFW.setGa2 s
    (Gather.setBrbBind (GBCA.ByAFW.ga2 s)
      (Function.update (Gather.brbBind (GBCA.ByAFW.ga2 s)) i
        ((Gather.brbBind (GBCA.ByAFW.ga2 s) i).recvMsg j k m)))
    ...
    (Gather.setBrbBind
      (Gather.setGa (GBCA.ByAFW.ga2 s)
        ((Gather.ga (GBCA.ByAFW.ga2 s)).setProc j
          { (Gather.ga (GBCA.ByAFW.ga2 s)).proc j with
            delivBind :=
              Function.update ((Gather.ga (GBCA.ByAFW.ga2 s)).proc j).delivBind i (some v) }))
      (Function.update (Gather.brbBind (GBCA.ByAFW.ga2 s)) i
        ((Gather.brbBind (GBCA.ByAFW.ga2 s) i).setProc j
          { (Gather.brbBind (GBCA.ByAFW.ga2 s) i).proc j with returned := true })))
...
theorem toRound_dlvBind2 (hu : (u j).2 = p) (r : ℕ) (i k : Fin P.n)
  ...
  rw [toRound_writeNoSent]
  refine roundStateAt_ext ?_ ?_ ?_ ?_
  · simp only [afterDlvBind2, GBCA.ByAFW.procs_setGa2, procs_toRound_eq, procs_toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · simp [afterDlvBind2]
  · simp only [afterDlvBind2, GBCA.ByAFW.ga1_setGa2, ga1_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    · simp only [ga_ga1_toRoundUpd]
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · funext k'
    ...
    · funext q
      ...
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · simp
  · simp only [afterDlvBind2, GBCA.ByAFW.ga2_setGa2, ga2_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
...
theorem toRound_dlvBind2_ret (hu : (u j).2 = p) (r : ℕ) (i k : Fin P.n)
  ...
  rw [toRound_writeNoSent]
  refine roundStateAt_ext ?_ ?_ ?_ ?_
  · simp only [afterBindRet2, afterDlvBind2, GBCA.ByAFW.procs_setGa2, procs_toRound_eq,
    procs_toRoundUpd, toProc]
    exact Function.update_eq_self _ _
  · simp [afterBindRet2, afterDlvBind2]
  · simp only [afterBindRet2, afterDlvBind2, GBCA.ByAFW.ga1_setGa2, ga1_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    · simp only [ga_ga1_toRoundUpd]
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · funext k'
    ...
    · funext q
      ...
      exact Prod.ext (Function.update_eq_self _ _) rfl
    · simp
  · simp only [afterBindRet2, afterDlvBind2, GBCA.ByAFW.ga2_setGa2, ga2_toRound,
    Gather.ga_setBrbBind, Gather.brbBind_setBrbBind]
    refine subStateAt_ext ?_ ?_ ?_ ?_
...
theorem toRound_byzGa1 (u : ∀ _ : Fin P.n, AFW.ProcRec P.n) (w : NetState P.n)
  ...
  · simp
  · simp
  · simp only [GBCA.ByAFW.ga1_setGa1, ga1_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
...
theorem toRound_byzGa2 (u : ∀ _ : Fin P.n, AFW.ProcRec P.n) (w : NetState P.n)
  ...
  · simp only [GBCA.ByAFW.ga1_setGa2, ga1_toRound]
    ...
    · simp
  · simp only [GBCA.ByAFW.ga2_setGa2, ga2_toRound]
    refine subStateAt_ext ?_ ?_ ?_ ?_
    · refine Prod.ext rfl (networkState_ext ?_ rfl)
...
theorem storeInv_of (hI : StoreInv P u w)
    (h1 : ∀ r k, InvStep P k (Gather.brbIn (GBCA.ByAFW.ga1 (toRound P u w r)) k)
      (Gather.brbIn (GBCA.ByAFW.ga1 (toRound P x v r)) k))
    (h2 : ∀ r k, InvStep P k (Gather.brbBind (GBCA.ByAFW.ga1 (toRound P u w r)) k)
      (Gather.brbBind (GBCA.ByAFW.ga1 (toRound P x v r)) k))
    (h3 : ∀ r k, InvStep P k (Gather.brbIn (GBCA.ByAFW.ga2 (toRound P u w r)) k)
      (Gather.brbIn (GBCA.ByAFW.ga2 (toRound P x v r)) k))
    (h4 : ∀ r k, InvStep P k (Gather.brbBind (GBCA.ByAFW.ga2 (toRound P u w r)) k)
      (Gather.brbBind (GBCA.ByAFW.ga2 (toRound P x v r)) k)) :
    StoreInv P x v :=
