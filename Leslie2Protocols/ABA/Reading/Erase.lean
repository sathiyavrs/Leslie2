...
The pipeline of `Reading/Flat.lean` carries the erasure from the adversary to the
...
/-- info: 'PLTS.ABA.Net.flat_erasure' depends on axioms: [propext, Classical.choice, Quot.sound] -/
#guard_msgs in
