...
% box, breaks a long name across lines. The xurl package allows the break after
% any character, which a long camel-case segment needs; where it is not
% installed, the break points are the listed characters.
\IfFileExists{xurl.sty}{\usepackage{xurl}}{\def\UrlBreaks{\do\.\do\_\do\/\do\-}}
\urlstyle{tt}
