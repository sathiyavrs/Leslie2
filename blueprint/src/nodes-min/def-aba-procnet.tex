\begin{definition}[The program of one process]
  ...
  The stage side is the fourteen rows \leandecl{PLTS.ABA.Net.GStageStep}: the eight multicasts of the ladder, the delivery, the two calls and the three returns.
