\begin{theorem}[The announced bit is inert]
  ...
  Each protocol achieves exactly the trace distributions its ghost-free reading achieves: \leandecl{PLTS.ABA.ABDY.protocol_erasure} and \leandecl{PLTS.ABA.AFW.protocol_erasure}, both instances of \leandecl{PLTS.ABA.Implementation.system_erasure}.
