\begin{theorem}[The announced bit is inert]
  ...
  Every conclusion of Theorem~\ref{thm:aba-main} and of Theorem~\ref{thm:aba-afw-main} therefore holds of the ghost-free system, Validity and Agreement included: \leandecl{PLTS.ABA.ABDY.protocol₀_safe} and \leandecl{PLTS.ABA.AFW.protocol₀_safe}.
\end{theorem}
