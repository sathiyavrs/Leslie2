\begin{theorem}[Forward simulation is a congruence for the composition operators]
  ...
  \uses{def:forwardsim, def:process-algebra, def:relabel, def:synchronised-product}
...
\begin{proof}\leanok
  \uses{def:forwardsim, def:process-algebra, def:synchronised-product, def:weakstep}
