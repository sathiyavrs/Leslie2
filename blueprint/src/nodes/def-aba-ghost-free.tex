\begin{definition}[The ghost-free reading]
  ...
  Each is the protocol it is named for with the adversary's record dropped and nothing else changed, so each speaks the same alphabet as the protocol and sits in the same composition.
