\begin{definition}[The graded-agreement round as a composition]
  ...
  Corruption is a label of the interface on which the programs stand still and the two gather instances corrupt together (D1).
