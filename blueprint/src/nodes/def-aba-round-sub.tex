\begin{definition}[The graded-agreement round as a composition]
  ...
  \lean{PLTS.ABA.GBCA.ByAFW.ProcRec}\lean{PLTS.ABA.GBCA.ByAFW.RoundEvent}\lean{PLTS.ABA.GBCA.ByAFW.ProgramLabel}\lean{PLTS.ABA.GBCA.ByAFW.programLabelMap}\lean{PLTS.ABA.GBCA.ByAFW.firstGatherLabelMap}\lean{PLTS.ABA.GBCA.ByAFW.secondGatherLabelMap}\lean{PLTS.ABA.GBCA.ByAFW.roundPrograms}\lean{PLTS.ABA.GBCA.ByAFW.RoundStateAt}\lean{PLTS.ABA.GBCA.ByAFW.roundAt}\leanok
  ...
  The round's own events are hidden and the result is read over the family alphabet: \leandecl{PLTS.ABA.GBCA.ByAFW.roundAt}, which takes the two gather systems as arguments.
