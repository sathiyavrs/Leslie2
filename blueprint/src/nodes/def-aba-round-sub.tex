\begin{definition}[The graded-agreement round as a composition]
  ...
  The graded-agreement layer is the $n$ programs under $\mathrm{synchronisedProduct}$ beside the network of Definition~\ref{def:aba-gbca-net}, and the layer runs in parallel with two gather instances of Definition~\ref{def:aba-gather-sub}, the first over payloads $\mathbb{B}$ and the second over payloads $\mathbb{B} \cup \{\bot\}$.
