...
\begin{proof}\leanok
  ...
  A program's return row takes the announced bit free, so each program is saturated along $\varphi$ and the synchronised group of Definition~\ref{def:synchronised-product} is saturated with it.
