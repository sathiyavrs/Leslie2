\begin{theorem}[The announced bit is inert]
  ...
  \lean{PLTS.ABA.Net.flat_erasure}\lean{PLTS.ABA.ABDY.protocol_erasure}\lean{PLTS.ABA.AFW.protocol_erasure}\lean{PLTS.ABA.ABDY.protocol₀_safe}\lean{PLTS.ABA.AFW.protocol₀_safe}\leanok
